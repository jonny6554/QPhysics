...
%                 @value : the new value for the pixel.
    ...
    methods(Access = private)
        ...
        function linearGrating(object, maxConstant, maxVarient, flip, startingValue)
            ...
            for i = 1:varient
                for j = 1:constant
                    object.pixelGroup(i,j).setGrayscale(SLMPixel.getMaximumGrayscale() - round(lineValue))
                end
            end
        end
